...
DECLSPEC_COLD static void private_semaphore_dump( struct object *obj, int verbose )
{
...
DECLSPEC_COLD static void shared_semaphore_dump( struct object *obj, int verbose )
{
